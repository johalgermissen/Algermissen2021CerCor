...
% Plots for Figure 3 in manuscript.
%
...
% Figure 3A, B: lockSettings = 'resplocked', band = 'theta', contrastType = 'Go';
% Figure 3C, D: lockSettings = 'stimlocked', band = 'theta', contrastType = 'Go';
% Figure 3E, F: lockSettings = 'stimlocked', band = 'alpha', contrastType = 'Conflict';
