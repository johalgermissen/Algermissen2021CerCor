...
% Plots for Figure S14 in supplementary material.
%
...
% Figure S14 A, B: lockSettings = 'stimlocked', band = 'theta' and band = 'beta', contrastType = 'GoLeftRight';
% Figure S14 C, D: lockSettings = 'resplocked', band = 'theta' and band = 'beta', contrastType = 'GoLeftRight';
...
job.contrastType        = 'GoLeftRight'; % 'Congruency' or 'Go' or 'GoLeftRight' or 'GoValence' or 'GoAccuracy' or 'Accuracy' or 'CongruentAccuracy' or 'IncongruentAccuracy'
% ERP-corrected:
...
% Time:
sigTime = job.sigTime;
% sigTime = [1.475 1.525]; % accuracy stim-locked
% sigTime = [0.325 0.500]; % accuracy resp-locked
