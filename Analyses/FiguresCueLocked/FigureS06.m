...
% Plots for Figure S06 in supplementary material.
%
...
%% Figure S06 B-D. SLICE DISPLAY MAPS:
...
%% Figure S06, E-G. fMRI PARAMETER ESTIMATES:
...
% Load data:
ROInames    = {'GLM2LeftPutamenValence','GLM2MedialCaudateValence','GLM2JBLIncongruency'};
...
for iROI = 1:length(ROInames)
    ...
    if strcmp(ROIname,'GLM2LeftPutamenValence') || strcmp(ROIname,'GLM2MedialCaudateValence')
        yLim = [-0.32 0.32];
        yTick = -1:.2:1;
    elseif strcmp(ROIname,'GLM2JBLIncongruency')
        yLim = [-0.2 0.75];
        yTick = -1.2:.4:1.2;
    else
        yLim = [-0.1 0.1];
