...
% Plots for Figure S10 in supplementary material.
%
...
% Figure S10 A, B: lockSettings = 'resplocked', band = 'theta', contrastType = 'Go';
% Figure S10 C, D: lockSettings = 'stimlocked', band = 'theta', contrastType = 'Go';
