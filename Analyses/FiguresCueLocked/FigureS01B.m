...
% Plots for Figure S01B in supplementary material.
%
...
%% Figure S01B B-D. SLICE DISPLAY MAPS:
...
%% Figure S01B E-G. fMRI PARAMETER ESTIMATES:
...
%% Figure S01B H. fMRI-RT correlation plots

addpath(fullfile(rootdir,'Analyses/EEG_Scripts/CueLockedAnalyses/TAfT'));

taft_correlation_regression_BOLD_RT_per_valence_split({'GLM1vmPFCValenceMan'},'vmPFC',false,true)
taft_correlation_regression_BOLD_RT_per_valence_split({'GLM1CingulateAnteriorValence'},'ACC',false,true)
taft_correlation_regression_BOLD_RT_per_valence_split({'GLM1vmPFCValenceMan'},'vmPFC',true,true)
taft_correlation_regression_BOLD_RT_per_valence_split({'GLM1CingulateAnteriorValence'},'ACC',true,true)
